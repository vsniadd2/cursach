...
{
    /// <inheritdoc />
    public partial class ProductionSaaSFoundation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UiTheme = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: false, defaultValue: "light"),
                    CurrencyCode = table.Column<string>(type: "character varying(8)", maxLength: 8, nullable: false, defaultValue: "BYN"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BadgeIcon = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StorageGbLimit = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BillingSubscriptions_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleTitle = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    AvatarLargeUrl = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    AvatarSmallUrl = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UsageMetrics_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContactEvents_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContactEvents_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProbabilityPct = table.Column<int>(type: "integer", nullable: false),
                    ExpectedCloseDateUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DecisionMaker = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityEvents_TenantId_CreatedAtUtc",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AutomationRules_TenantId_Trigger_IsEnabled",
                table: "AutomationRules",
                columns: new[] { "TenantId", "Trigger", "IsEnabled" });

            migrationBuilder.CreateIndex(
                name: "IX_BillingSubscriptions_TenantId",
                table: "BillingSubscriptions",
                column: "TenantId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Clients_TenantId_Company_FullName",
                table: "Clients",
                columns: new[] { "TenantId", "Company", "FullName" });

            migrationBuilder.CreateIndex(
                name: "IX_ContactEvents_ClientId",
                table: "ContactEvents",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_ContactEvents_TenantId_ClientId_OccurredAtUtc",
                table: "ContactEvents",
                columns: new[] { "TenantId", "ClientId", "OccurredAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deals_TenantId_ClientId_Stage",
                table: "Deals",
                columns: new[] { "TenantId", "ClientId", "Stage" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IntegrationJobs_TenantId_Status_ScheduledAtUtc",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupportTickets_TenantId_Status_CreatedAtUtc",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsageMetrics_TenantId_MetricKey_RecordedAtUtc",
                table: "UsageMetrics",
                columns: new[] { "TenantId", "MetricKey", "RecordedAtUtc" });
