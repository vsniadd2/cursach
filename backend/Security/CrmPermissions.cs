...
public static class CrmPermissions
{
    ...
    public const string AutomationsWrite = "crm.automations.write";
    ...
    [
        ...
        IntegrationsRead, IntegrationsWrite, BillingRead, BillingWrite, AuditRead, AutomationsWrite, Admin
    ];
}
